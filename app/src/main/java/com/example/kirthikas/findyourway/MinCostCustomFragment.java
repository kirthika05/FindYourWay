...
public class MinCostCustomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.min_cost_main, container, false);
    ...
    private void loadGrid(int[][] contents) {
        ...
        ((TextView) getView().findViewById(R.id.grid_contents)).setText(validGrid.asFormattedString("\t"));
    }
